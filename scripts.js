...
const enderecoPreenchido = ["cep", "logradouro", "bairro", "cidade", "estado", "numero"];

window.addEventListener("DOMContentLoaded", () => {
    enderecoPreenchido.forEach(campo => {
...
enderecoPreenchido.forEach(campo => {
    document.getElementById(campo).addEventListener("input", (evento) => {
        localStorage.setItem(campo, evento.target.value);
    })
})